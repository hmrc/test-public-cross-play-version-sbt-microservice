package uk.gov.hmrc.testpubliccrossplayversionsbtmicroservice
...
class ExampleIntegrationTest extends WordSpec with Matchers with ServiceSpec  {
  ...
  "This integration test" should {
    "start services via smserver" in {
      ...
      val response = wsClient.url(resource("/test-public-cross-play-version-sbt-microservice/hello-world")).get.futureValue
